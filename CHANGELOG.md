...
* fix code signing [Dan Goodman]
* Ran build [Dan Goodman]
* Add signing for other binaries [Dan Goodman]
* More logging [Dan Goodman]
* Added logging [Dan Goodman]
* Align comments [Dan Goodman]
* Update to codesign .node files [Dan Goodman]
* Fix whichspawn command [Dan Goodman]
* Build format file [Dan Goodman]
* Walk instead of find [Dan Goodman]
* fix shrinkwrap and package.json [Dan Goodman]
* Formatting [Dan Goodman]
* Fix dependency [Dan Goodman]
* Fix other npm changes [Dan Goodman]
* fix npm shrinkwrap [Dan Goodman]
* Change logging [Dan Goodman]
* Add productsign to all .node files [Dan Goodman]
* Fix shrinkwrap [Dan Goodman]
* remove file [Dan Goodman]
* Test path to include any .zip file with 'test' in the path [Dan Goodman]
* Makes more sense [Dan Goodman]
* Update walk and delete zip files [Dan Goodman]
* Add zip file deletion to remove notarization errors on macos [Dan Goodman]
* Semicolon [Dan Goodman]
* Throw error intentionally [Dan Goodman]
* Move notarization into macos only [Dan Goodman]
* Remove net-keepalive dependency [Dan Goodman]
* Fix path [Dan Goodman]
* Fixed optional dependencies [Dan Goodman]
* Fixed lockfile and shrinkwrap file [Dan Goodman]
* Update macOS installer to avoid Apple's warning pop-up [Dan Goodman]
